...
- TypeScript (Bun runtime) + Bash (script/setup) + uv (astral-sh/uv v0.10.2), skypilot-nightly[aws] (003-skypilot-installer)
...
## Recent Changes
- 003-skypilot-installer: Added TypeScript (Bun runtime) + Bash (script/setup) + uv (astral-sh/uv v0.10.2), skypilot-nightly[aws]
